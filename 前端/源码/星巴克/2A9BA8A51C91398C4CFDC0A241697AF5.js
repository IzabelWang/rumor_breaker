...
e = (t = r).lib.WordArray, t.enc.Base64 = {
    ...
    f = f.MD5 = a.extend({
        ...
        _doProcessBlock: function(t, r) {
            ...
            o = this._hash.words;
            var a = t[r + 0], f = (c = t[r + 1], t[r + 2]), u = t[r + 3], p = t[r + 4], d = t[r + 5], l = t[r + 6], y = t[r + 7], v = t[r + 8], _ = t[r + 9], g = t[r + 10], B = t[r + 11], x = t[r + 12], m = t[r + 13], k = t[r + 14], S = t[r + 15], z = e(z = o[0], D = o[1], C = o[2], w = o[3], a, 7, h[0]), w = e(w, z, D, C, c, 12, h[1]), C = e(C, w, z, D, f, 17, h[2]), D = e(D, C, w, z, u, 22, h[3]);
            z = e(z, D, C, w, p, 7, h[4]), w = e(w, z, D, C, d, 12, h[5]), C = e(C, w, z, D, l, 17, h[6]), 
            D = e(D, C, w, z, y, 22, h[7]), z = e(z, D, C, w, v, 7, h[8]), w = e(w, z, D, C, _, 12, h[9]), 
            ...
            D = i(D, C, w, z, p, 20, h[23]), z = i(z, D, C, w, _, 5, h[24]), w = i(w, z, D, C, k, 9, h[25]), 
            C = i(C, w, z, D, u, 14, h[26]), D = i(D, C, w, z, v, 20, h[27]), z = i(z, D, C, w, m, 5, h[28]), 
            w = i(w, z, D, C, f, 9, h[29]), C = i(C, w, z, D, y, 14, h[30]), z = n(z, D = i(D, C, w, z, x, 20, h[31]), C, w, d, 4, h[32]), 
            w = n(w, z, D, C, v, 11, h[33]), C = n(C, w, z, D, B, 16, h[34]), D = n(D, C, w, z, k, 23, h[35]), 
            ...
            C = n(C, w, z, D, u, 16, h[42]), D = n(D, C, w, z, l, 23, h[43]), z = n(z, D, C, w, _, 4, h[44]), 
            ...
            D = s(D, C, w, z, c, 21, h[55]), z = s(z, D, C, w, v, 6, h[56]), w = s(w, z, D, C, S, 10, h[57]), 
            C = s(C, w, z, D, l, 15, h[58]), D = s(D, C, w, z, m, 21, h[59]), z = s(z, D, C, w, p, 6, h[60]), 
            w = s(w, z, D, C, B, 10, h[61]), C = s(C, w, z, D, f, 15, h[62]), D = s(D, C, w, z, _, 21, h[63]);
    ...
    for (y = 0; 256 > y; y++) {
        ...
        n[v] = g, s[g] = v;
        var B = l[v], x = l[B], m = l[x], k = 257 * l[g] ^ 16843008 * g;
        o[v] = k << 24 | k >>> 8, c[v] = k << 16 | k >>> 16, a[v] = k << 8 | k >>> 24, f[v] = k, 
        k = 16843009 * m ^ 65537 * x ^ 257 * B ^ 16843008 * v, h[g] = k << 24 | k >>> 8, 
        u[g] = k << 16 | k >>> 16, p[g] = k << 8 | k >>> 24, d[g] = k, v ? (v = B ^ l[l[l[m ^ B]]], 
        _ ^= l[l[_]]) : v = _ = 1;
    }
    ...
    i = i.AES = e.extend({
        ...
        _doCryptBlock: function(t, e, r, i, n, s, o, c) {
            for (var a = this._nRounds, f = t[e] ^ r[0], h = t[e + 1] ^ r[1], u = t[e + 2] ^ r[2], p = t[e + 3] ^ r[3], d = 4, l = 1; l < a; l++) {
                var y = i[f >>> 24] ^ n[h >>> 16 & 255] ^ s[u >>> 8 & 255] ^ o[255 & p] ^ r[d++], v = i[h >>> 24] ^ n[u >>> 16 & 255] ^ s[p >>> 8 & 255] ^ o[255 & f] ^ r[d++], _ = i[u >>> 24] ^ n[p >>> 16 & 255] ^ s[f >>> 8 & 255] ^ o[255 & h] ^ r[d++];
...
var i = {
    stringify: function(t) {
        var e = {
            ct: t.ciphertext.toString(r.enc.Base64)
        };
        return t.iv && (e.iv = t.iv.toString()), t.salt && (e.s = t.salt.toString()), JSON.stringify(e).replace(/\s/g, "");
    },
    parse: function(t) {
        var e = JSON.parse(t), i = r.lib.CipherParams.create({
            ciphertext: r.enc.Base64.parse(e.ct)
        });
        return e.iv && (i.iv = r.enc.Hex.parse(e.iv)), e.s && (i.salt = r.enc.Hex.parse(e.s)), 
        i;
    }
};
